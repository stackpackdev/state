...
// ── Boilerplate counter: 1x createContext, 1x useReducer, 2x useCallback, 1x useContext ──
...
const FAKE_USERS: Record<string, User> = {
  admin: { id: 'u1', name: 'Alice Admin', email: 'alice@example.com', avatar: 'AA' },
  user: { id: 'u2', name: 'Bob User', email: 'bob@example.com', avatar: 'BU' },
};
