// state-agent core type definitions
// Extracted from Views Tools Data.js, Flow.js, walk.js patterns
...
// ─── Action Types ────────────────────────────────────────────
// Extracted from Data.js reducer (SET, SET_FN, RESET) + Flow.js (SET, SET_BUFFERED)
...
// ─── Store Types ─────────────────────────────────────────────
// Extracted from Data.js DataProvider + DataContexts pattern
...
// ─── Listener Types ──────────────────────────────────────────
// Extracted from Data.js registerListener pattern (lines 93-143)
...
// ─── Middleware Types ────────────────────────────────────────
// Extracted from walk.js visitor pattern: enter can cancel, leave for side-effects
...
// ─── Flow Types ──────────────────────────────────────────────
// Extracted from Flow.js flowDefinition, getNextFlow, has()
...
// ─── Transform Types ─────────────────────────────────────────
// Extracted from Data.js formatIn/formatOut (useDataFormat, useDataChange)
...
// ─── Together Types ──────────────────────────────────────────
// Extracted from DataProvider wrapping sections with shared context
...
// Extracted from Data.js dual-state architecture (_state vs state)
...
// ─── Registry Types ──────────────────────────────────────────
// Extracted from DataContexts = {} global lazy registry
...
// ─── Store Dependencies ─────────────────────────────────────
// Explicit edges in the store dependency graph for agent traversal
...
// ─── Path Schema ────────────────────────────────────────────
// Deterministic schema for agent traversal without parsing TypeScript

export type PathSchemaType =
  | 'string'
  | 'number'
  | 'boolean'
  | 'object'
...
// ─── Presence Types ──────────────────────────────────────────
// Lifecycle phases for animated elements with deferred unmounting.
// Presence is a superset of Gate: mounts when condition is true,
// delays unmounting until leave animation completes.
